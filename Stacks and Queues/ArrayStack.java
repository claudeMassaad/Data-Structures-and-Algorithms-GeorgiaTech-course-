...
public class ArrayStack<T> {
    ...
    public void push(T data) {
        //Exception
        if (data == null) {
            throw new IllegalArgumentException("The data is null! It cannot be added to the stack.");
        }
    ...
    public T pop() {
        if (size == 0) {
            throw new NoSuchElementException("The list is empty! There is nothing to pop.");
        }
        size--;
        Object removed = backingArray[size];
